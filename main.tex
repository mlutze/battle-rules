...
\]
\begin{itemize}
    \item can calculate via assuming only perifery will attack, etc.
\end{itemize}
\subsection{Scaling Space}

\begin{itemize}
    \item 5 square feet per creature
    \item 10 square feet per large, etc.
    \item can use min unit area as baseline
\end{itemize}
