...
%
\begin{itemize}
    \item $n_\minn$ (minimum health factor) the minimum value of the health factor among all units
    \item $d_\medd$ (median attack factor) the median value of the attack factor among all units
    \item $e_\minn$ (minimum space factor) the minimum value of the space factor among all units
    \item $u_\medd$ (median unit number) the median number of creatures in a unit
    \item $p_\minn$ (minimum unit speed) the minimum value of the speed of creatures in a unit
\end{itemize}
